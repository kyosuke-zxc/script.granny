...
-- ВЫСТАВИЛИ ЮВЕЛИРНЫЕ 0.37 ДЛЯ СТРОКИ ПОИСКА
local SearchBox = Instance.new("TextBox", MainFrame)
SearchBox.Name, SearchBox.Size, SearchBox.Position, SearchBox.BackgroundColor3, SearchBox.TextColor3, SearchBox.TextSize, SearchBox.Font, SearchBox.PlaceholderText, SearchBox.Text = "SearchBox", UDim2.new(0.9, 0, 0, 25), UDim2.new(0.05, 0, 0.37, 0), Color3.fromRGB(35, 35, 40), Color3.fromRGB(255, 255, 255), 12, Enum.Font.SourceSans, "Type item name here...", ""
Instance.new("UICorner", SearchBox).CornerRadius = UDim.new(0, 5)

-- ВЫСТАВИЛИ ЮВЕЛИРНЫЕ 0.37 ДЛЯ КНОПОК FLY И NOCLIP
local MoveControlsFrame = Instance.new("Frame", MainFrame)
MoveControlsFrame.Name, MoveControlsFrame.BackgroundTransparency, MoveControlsFrame.Position, MoveControlsFrame.Size = "MoveControlsFrame", 1, UDim2.new(0.05, 0, 0.37, 0), UDim2.new(0.9, 0, 0, 40)
